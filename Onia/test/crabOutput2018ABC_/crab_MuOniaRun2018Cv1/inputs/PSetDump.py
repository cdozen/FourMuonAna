...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/uscms/store/user/muahmad/FourMuon_Analysis/MuOnia/2018D_v2/MuOnia/BPHSkim--Run2018D-PromptReco-v2/190624_111618/0000/BPHSkim_2018D_1.root')
)
...
process.rootuple = cms.EDAnalyzer("MuMuGammaRootupler",
    OnlyBest = cms.bool(False),
    OnlyGen = cms.bool(False),
    SecondSource = cms.SecSource("EmbeddedRootSource",
...
,
    ...
    onia_mass_cuts = cms.vdouble(0.1, 500),
    onia_pdgid = cms.uint32(553),
    primaryVertices = cms.InputTag("offlinePrimaryVertices"),
    triggerCuts = cms.uint32(36),
    triggerList = cms.untracked.vstring('HLT_Trimuon5_3p5_2_Upsilon_Muon_v'),
    upsilon_mass = cms.double(9.4603)
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('102X_dataRun2_Sep2018ABC_v2'),
